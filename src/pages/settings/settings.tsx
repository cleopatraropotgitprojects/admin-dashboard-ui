...
const SettingsPage = () => {
    const { user } = useAuth();
    const isSuperiorAdmin = user === 'cleopatraproject@admin.com';
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl shadow p-6 space-y-4">
                ...
                {isSuperiorAdmin ? (
                    ...
                    <div className="space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
                        <p><strong>Full Name:</strong> Admin Client</p>
                        <p><strong>Email:</strong> admin</p>
                        <p className="italic text-zinc-500 dark:text-zinc-400">You do not have permission to edit profile details.</p>
                    </div>
                )}
            </div>
